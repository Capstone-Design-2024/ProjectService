...
public enum StatusCode {
    ...
    ALREADY_CREATED_PROJECT(400, "이미 생성된 프로젝트입니다. 수정 API를 사용하십시오.", HttpStatus.BAD_REQUEST),
    NOT_EXIST_FILE(400, "파일이 존재하지 않습니다.", HttpStatus.BAD_REQUEST),
    INVALID_DATA_FORMAT(400, "형식이 맞지 않습니다.", HttpStatus.BAD_REQUEST),
    INVALID_ROLE(400, "ROLE 형식이 맞지 않습니다.", HttpStatus.BAD_REQUEST),
    IO_EXCEPTION_ON_IMAGE_UPLOAD(400, "이미지 업로드 중 에러가 발생했습니다.", HttpStatus.BAD_REQUEST);
    ;
    @Getter
